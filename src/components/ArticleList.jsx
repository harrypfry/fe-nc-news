      ...
      <table className="article-table">
        <tbody>
          {this.state.articles.map(article => {
            return (
              <tr className="article-table-row" key={article.article_id}>
                ...
                <td className="title-col">
                  ...
                  <div className="info-in-table">
                    written by {article.author} | {article.comment_count}{" "}
                    comments | 03/04/1993
                  </div>
                </td>
              </tr>
          ...
          <tr className="article-table-row">
            ...
            <td className="title-col">
              ...
              <div className="info-in-table">
                written by {this.state.articles[0].author} |{" "}
                {this.state.articles[0].comment_count} comments | 03/04/1993
              </div>
            </td>
          </tr>
        </tbody>
